...
# MAGIC %md
# MAGIC In this case we will load it from the `daipeproject.silver.tbl_repayments.schema` python module which contains the following code:
# MAGIC
# MAGIC ```python
...
from daipeproject.silver.tbl_repayments.schema import get_schema
