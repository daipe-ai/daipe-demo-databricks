...
from daipeproject.silver.tbl_loans_schema import get_schema as get_loans_schema
from daipeproject.silver.tbl_repayments.schema import get_schema as get_repayments_schema
